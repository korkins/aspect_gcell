/*
TODO:
	1. Accelerate Humlichek
	2. Limit file size\memory usage - notify user and terminate execution
NOTES:
    Command line arguments in VS: Project Properties\Configuration Properties\Debugging\Command Arguments

	Input:
	-molec_id:: 1:H2O, 2:CO2, 3:O3, 4:N2O, 5:CO, 6:CH4; 7:O2, 10:NO2
	-typical bands::
	--AO2: 13050-13160; BO2=14490-14600;
